...
def main():
    ...
    model_config_file = './stable_audio_tools/configs/model_config2.json'
    ...
    state_dict = {k: v for k, v in state_dict.items() if 'pretransform' in k}
    ...
    demo_callback = DiffusionCondDemoCallback(test_dataloader=test_dataloader, every_n_epochs=1, sample_rate=sample_rate)
    devices = [0,1,2,3] 
